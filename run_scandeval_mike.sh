...
# Danish
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m google/gemma-7b
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m google/gemma-7b-it
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m 01-ai/Yi-1.5-9B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m utter-project/EuroLLM-9B-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m utter-project/EuroLLM-9B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m google/gemma-2-9b-it
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m google/gemma-2-9b
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m tiiuae/Falcon3-10B-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m tiiuae/Falcon3-10B-Base
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m upstage/SOLAR-10.7B-v1.0
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m timpal0l/sol
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m tiiuae/falcon-11B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m speakleash/Bielik-11B-v2.3-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m norallm/normistral-11b-warm
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m mistralai/Mistral-Nemo-Instruct-2407
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m bineric/NorskGPT-Llama-13B-v0.1
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m RuterNorway/Llama-2-13b-chat-norwegian
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Llama-2-13b-hf
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Llama-2-13b-chat-hf
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m allenai/OLMo-2-1124-13B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m LumiOpen/Viking-13B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m HPLT/gpt-13b-nordic-prerelease
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m AI-Sweden-Models/gpt-sw3-20b
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m mistralai/Mistral-Small-24B-Instruct-2501
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m google/gemma-2-27b-it
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m ThatsGroes/gemma-2-27b-it-FP8-Dynamic
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m CohereForAI/aya-expanse-32b
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m CohereForAI/c4ai-command-r-08-2024
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m Qwen/QwQ-32B-Preview
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m LumiOpen/Viking-33B@1000B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m HPLT/gpt-33b-nordic-prerelease
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m CohereForAI/c4ai-command-r-v01
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m AI-Sweden-Models/gpt-sw3-40b
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m mistralai/Mixtral-8x7B-v0.1
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m mistralai/Mixtral-8x7B-Instruct-v0.1
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m NorwAI/NorwAI-Mixtral-8x7B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m NorwAI/NorwAI-Mixtral-8x7B-instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Llama-3.3-70B-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Llama-3.1-70B-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Meta-Llama-3-70B
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Meta-Llama-3-70B-instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m nvidia/Llama-3.1-Nemotron-70B-Instruct-HF
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m Qwen/Qwen2.5-72B-Instruct
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m mgoin/Nemotron-4-340B-Instruct-hf-FP8
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da --dataset danish-citizen-tests -m meta-llama/Llama-3.1-405B-Instruct-FP8
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da -m 152334H/miqu-1-70b-sf
euroeval --evaluate-test-split --clear-model-cache --trust-remote-code -l da -m meta-llama/Llama-2-70b-hf
